  ...
  return (
    <div className="auth-wrap">
      <div className="auth-box">
        <div className="auth-plate"><img src="/v5-icon.png" alt="Vouch5" style={{height:"clamp(120px,22vw,220px)",display:"block",margin:"0 auto"}} /></div>
    ...
    <>
      ...
      <div className="app">
        ...
        <header className="masthead">
          ...
          <div className="masthead-nameplate"><img src="/v5-icon.png" alt="Vouch5" style={{height:"clamp(120px,22vw,220px)",display:"block",margin:"0 auto"}} /></div>
      ...
      <div className="app">
        <header className="masthead">
          ...
          <div className="masthead-nameplate" onClick={() => { setTab("board"); setViewing(null); window.history.replaceState({}, "", "/"); scrollToTop(); }}>
            <img src="/v5-icon.png" alt="Vouch5" style={{height:"clamp(120px,22vw,220px)",display:"block",margin:"0 auto"}} />
          </div>
          <div className="masthead-rule-ornament"><span>—</span><span>✦</span><span>—</span></div>
          <div className="masthead-tagline">Love it? Vouch for it.</div>
          <nav className="nav">
