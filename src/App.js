            ...
            : <>
                <div style={{ marginBottom: 8, display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12 }}>
                  ...
                  <div style={{ display: "flex", gap: 8, marginTop: 4, flexShrink: 0 }}>
                    ...
                    {!viewing && (
                      <button onClick={() => setShareModal(true)} style={{ fontFamily: "'Spectral SC',serif", fontSize: "11px", letterSpacing: "0.18em", padding: "10px 20px", background: T.ink, color: T.bg, border: "none", cursor: "pointer", whiteSpace: "nowrap", fontWeight: 600 }}>Share Your Board</button>
                    )}
                  </div>
                </div>
                {viewing && (
